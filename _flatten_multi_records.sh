...
# all visits
flatten_multi_records.py ${1}_current_pharmaceutical_treatment_floating_med_125.csv
flatten_multi_records.py ${1}_current_pharmaceutical_treatment_floating_med_2650.csv

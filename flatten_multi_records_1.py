...
'blood_sample_preanalytic_quality_assurance_bc': {'visit': [2,4], 'vars': ['chrblood_bc?id','chrblood_bc?vol','chrblood_bc?pos','chrblood_bc?box','chrblood_bcfrztime']},
'blood_sample_preanalytic_quality_assurance_pl': {'visit': [2,4], 'vars': ['chrblood_pl?id','chrblood_pl?vol','chrblood_pl?pos','chrblood_pl?hem','chrblood_plfrztime']},
'blood_sample_preanalytic_quality_assurance_wb': {'visit': [2,4], 'vars': ['chrblood_wb?id','chrblood_wb?vol','chrblood_wb?pos','chrblood_wbfrztime']},
'blood_sample_preanalytic_quality_assurance_se': {'visit': [2,4], 'vars': ['chrblood_se?id','chrblood_se?vol','chrblood_se?pos','chrblood_serumfrztime','chrblood_sehem','chrblood_selip']},
